...
class RiwayatSemuaExport implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    protected $filters;
    ...
    {
        $query = LogAktivitasHarian::whereYear('tanggal', $this->filters['tahun'])
